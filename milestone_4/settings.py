...
ALLOWED_HOSTS =['vitality-milestone-4.herokuapp.com', 'https://juginowakowska-milestone-d437z7ybvm.us2.codeanyapp.com/#/workspaces/Milestone-4', 'localhost' ]
...
DEFAULT_FROM_EMAIL = 'vitality@example.com'
